...
assert_contains "$CONFIG_FILE" 'name: "statlite-self"'
assert_contains "$CONFIG_FILE" 'type: "statlite-metrics"'
assert_contains "$CONFIG_FILE" 'url: "http://127.0.0.1:9090/statlite/metrics"'
