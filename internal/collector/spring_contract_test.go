	...
	return []springContractFixture{
		...
		},
		{
			...
			baselineEvents: []CollectorEvent{
				...
				{Severity: EventSeverityError, Type: "metrics_unavailable", Message: "spring metrics collection produced no usable samples"},
			},
		},
		{
		...
		},
		{
			...
			responses: map[string]springScriptedResponse{
				"/actuator/health":                    {status: http.StatusUnauthorized, body: `{"error":"Unauthorized"}`},
				"/actuator/metrics/process.cpu.usage": springOK(processCPU),
			},
			wantNormalized: springNormalizedSnapshot{samples: []MetricSample{{Key: "process_cpu_usage", Kind: MetricKindGauge, Value: 0.12, Unit: "ratio"}}},
			baselineRequests: springRequestCounts(
				"/actuator/health",
				"/actuator/metrics/http.server.requests",
				"/actuator/metrics/jvm.memory.used?tag=area%3Aheap",
			...
			baselineEvents: []CollectorEvent{
				{Severity: EventSeverityWarning, Type: "health_fetch_failed", Message: `actuator health returned HTTP 401: {"error":"Unauthorized"}`},
				springFetchWarning("http_requests_total", "actuator metrics/http.server.requests returned HTTP 404: not found"),
				springFetchWarning("jvm_heap_used_bytes", "actuator metrics/jvm.memory.used returned HTTP 404: not found"),
				springFetchWarning("process_start_time", "actuator metrics/process.start.time returned HTTP 404: not found"),
			},
		},
		{
			...
			baselineEvents: []CollectorEvent{
				{Severity: EventSeverityWarning, Type: "health_fetch_failed", Message: `actuator health returned HTTP 404: {"error":"Not Found"}`},
				springFetchWarning("http_requests_total", "actuator metrics/http.server.requests returned HTTP 404: not found"),
				springFetchWarning("jvm_heap_used_bytes", "actuator metrics/jvm.memory.used returned HTTP 404: not found"),
				springFetchWarning("process_start_time", "actuator metrics/process.start.time returned HTTP 404: not found"),
			},
		},
		{
			...
			responses: map[string]springScriptedResponse{
				"/actuator/health":                    springOK(`{"status":`),
				"/actuator/metrics/process.cpu.usage": springOK(processCPU),
			},
			wantNormalized: springNormalizedSnapshot{samples: []MetricSample{{Key: "process_cpu_usage", Kind: MetricKindGauge, Value: 0.12, Unit: "ratio"}}},
			baselineRequests: springRequestCounts(
			...
			baselineEvents: []CollectorEvent{
				{Severity: EventSeverityWarning, Type: "health_fetch_failed", Message: "parsing actuator health response: unexpected end of JSON input"},
				springFetchWarning("http_requests_total", "actuator metrics/http.server.requests returned HTTP 404: not found"),
				springFetchWarning("jvm_heap_used_bytes", "actuator metrics/jvm.memory.used returned HTTP 404: not found"),
				springFetchWarning("process_start_time", "actuator metrics/process.start.time returned HTTP 404: not found"),
			},
		},
		{
			...
			baselineEvents: []CollectorEvent{
				{Severity: EventSeverityWarning, Type: "health_fetch_failed", Message: `fetching actuator health: Get "http://spring.test/actuator/health": transport unavailable`},
				springFetchWarning("http_requests_total", `fetching actuator metrics/http.server.requests: Get "http://spring.test/actuator/metrics/http.server.requests": transport unavailable`),
				springFetchWarning("jvm_heap_used_bytes", `fetching actuator metrics/jvm.memory.used: Get "http://spring.test/actuator/metrics/jvm.memory.used?tag=area%3Aheap": transport unavailable`),
				springFetchWarning("process_cpu_usage", `fetching actuator metrics/process.cpu.usage: Get "http://spring.test/actuator/metrics/process.cpu.usage": transport unavailable`),
				springFetchWarning("process_start_time", `fetching actuator metrics/process.start.time: Get "http://spring.test/actuator/metrics/process.start.time": transport unavailable`),
				{Severity: EventSeverityError, Type: "metrics_unavailable", Message: "spring metrics collection produced no usable samples"},
			},
		},
	}
