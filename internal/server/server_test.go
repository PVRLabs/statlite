...
func TestRootServesDashboardPage(t *testing.T) {
	...
	for _, want := range []string{
		...
		`id="footer-refresh"`,
		"App status",
		"UP means either the application reported positive health or StatLite successfully collected metrics.",
		"Not reported means database health was not reported by this integration.",
		"Current status",
		`aria-label="Target"`,
		`id="target-select"`,
		"Requests",
