...
Start with the application's base URL. StatLite can identify a supported
...
next command. It is read-only: it does not require or create `statlite.yaml`,
open SQLite, or start monitoring.
